        ...
        <HomeLayout> 
            ...
            <div className="sm:pt-4 mx-6 lg:pt-10 text-white flex flex-col lg:flex-row items-center justify-center gap-10 lg:mx-16 h-[90vh]">
                <div className="lg:w-1/2  order-2 lg:-order-none space-y-6">
                    ...
                    <div className="flex justify-evenly md:justify-normal space-x-6 md:space-x-6">
                        <Link to={"/courses"}>
                        ...
                        <Link to={"/contact"}>
                            <button className=" border border-yellow-600 rounded-md px-4 md:px-5 py-3 text-lg cursor-pointer hover:bg-yellow-600 transition-all ease-in-out duration-300">
                                Contact Us
                            </button>
                        </Link>
                    </div>
